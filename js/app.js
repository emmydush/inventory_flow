...
async function loadDashboard() {
    try {
        ...
        if (result.success) {
            const d = result.data;
            document.getElementById('todaySales').textContent = (state.settings.currency_symbol?.value || 'FRW') + ' ' + formatNumber(d.today_sales.total);
            document.getElementById('monthSales').textContent = (state.settings.currency_symbol?.value || 'FRW') + ' ' + formatNumber(d.month_sales.total);
            ...
            document.getElementById('pendingCredits').textContent = (state.settings.currency_symbol?.value || 'FRW') + ' ' + formatNumber(d.pending_credits.total);
        }

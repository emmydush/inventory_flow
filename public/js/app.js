    ...
    try {
        ...
        if (result.success) {
            ...
            Object.keys(result.data).forEach(key => {
                ...
                if (el) el.value = result.data[key].value || '';
            });
        }
...
function navigateTo(page) {
    ...
    const titles = { dashboard: 'Dashboard', pos: 'Point of Sale', products: 'Products', categories: 'Categories', customers: 'Customers', suppliers: 'Suppliers', sales: 'Sales History', credit: 'Credit Sales', reports: 'Reports', transactions: 'Stock History', settings: 'Settings' };
